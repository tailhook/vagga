...
@test "ubuntu: Repo simple" {
    ...
    repo_line=$(cat ".vagga/repo-simple/etc/apt/sources.list.d/f68b6841-xenial.list")
    [[ $repo_line = *" xenial universe" ]]
...
@test "ubuntu: Repo with suite" {
    ...
    repo_line=$(cat ".vagga/repo-with-suite/etc/apt/sources.list.d/f68b6841-xenial.list")
    [[ $repo_line = *" xenial universe" ]]
