...
wget --no-use-server-timestamp $mirror/v3.1/main/x86_64/apk-tools-static-2.5.0_rc1-r1.apk -O apk-tools-static-2.5.0_rc1-r1.apk
...
sha1sum -c <<SHA1SUMS
d191b9f662891d6219ac1bfc4907242d35f5f024  apk-tools-static-2.5.0_rc1-r1.apk
...
tar -xf alpine/apk-tools-static-2.5.0_rc1-r1.apk sbin/apk.static -O > apk
